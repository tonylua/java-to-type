...
public class ExcelConstant {
    ...
    public static final String IMAGE_TOPIC = "fa fa-university";  //图标1
    public static final String IMAGE_SUBJECT_MATTER = "fa fa-file-text-o";  //icon2

    public static final String IMAGE_RESULT2 = "fa fa-sign-out";
    public static final String IMAGE_RESUlt3 = "3";
